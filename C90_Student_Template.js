...
function car1_down()
{
  ...
  {
	car1_y = car1_y+ 10;
	console.log("Cuando se presiona la flecha abajo, x = " + car1_x + " y = " +car1_y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
  }
...
function car1_left()
{
  ...
  {
	car1_x = car1_x - 10;
	console.log("Cuando se presiona la flecha izquierda, x = " + car1_x + " y = " +car1_y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
  }
...
function car1_right()
{
  ...
  {
	car1_x =car1_x + 10;
	console.log("Cuando se presiona la flecha derecha, x = " + car1_x + " y = " +car1_y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
  }
